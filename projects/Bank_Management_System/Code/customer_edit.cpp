...
int Customer_Edit::Check_Authorization()
{
    ...
    if(!flag)
    {
        ...
        {
            qDebug() <<"Customer_Password is "<<Customer_Password;
            qDebug() <<"Customer__Pass is "<<Customer__Pass;
...
void Customer_Edit::on_pushButton_clicked()
{
    ...
    if(Customer_ID > 0)
    {
        ...
        qDebug () << "Delete the account "<<Customer_ID ;

        // inform that the account deleted
        int res;
