...
void BankLoan::Set_Loan_Amount(float m_Loan_Amount)
{
    ...
    qDebug() <<"m_Loan_Amount" <<m_Loan_Amount;
}
/**
...
void BankLoan::Set_Loan_Duration(int m_Loan_Duration)
{
    ...
    qDebug() <<"m_Loan_Duration" <<m_Loan_Duration;
